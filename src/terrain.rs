...
// Carve an L-shaped corridor between a pair of coordinates
...
pub fn generate_dungeon<R: Rng>(size: Size, rng: &mut R) -> Grid<TerrainTile> {
    ...
    // Add corridos connecting every adjacent pair of room centres
...
impl Room {
    ...
    // Top and left sides of the room are set to `Some(TerrainTile::Wall`) instead.
